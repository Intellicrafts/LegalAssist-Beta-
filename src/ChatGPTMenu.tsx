    ...
    <MenuRoot>
      <MenuTrigger asChild>
        <Button
          ...
          color='fg.muted'
        >
          Legal Assist <MenuIcon />
        </Button>
      </MenuTrigger>
      <MenuContent minW='320px' borderRadius='2xl'>
        <MenuItem value='legalassist-plus' py='2'>
          <MenuItemDetail
            title='LegalAssist Plus'
            icon={<ChatGPTPlusIcon />}
            description='Our smartest Law Agent.& more'
            element={
        ...
        <MenuItem value='talk-to-lawyer' py='2'>
          <MenuItemDetail
            title='Talk To Lawyer'
            icon={<ChatGPTMenuIcon />}
            description='Great for Personal consultant'
